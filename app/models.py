...
GATEWAY_HEALTH_STATUS_UNKNOWN = "unknown"
GATEWAY_HEALTH_STATUS_HEALTHY = "healthy"
GATEWAY_HEALTH_STATUS_DEGRADED = "degraded"
GATEWAY_HEALTH_STATUS_UNREACHABLE = "unreachable"

GATEWAY_HEALTH_STATUSES = {
    GATEWAY_HEALTH_STATUS_UNKNOWN,
    GATEWAY_HEALTH_STATUS_HEALTHY,
    GATEWAY_HEALTH_STATUS_DEGRADED,
    GATEWAY_HEALTH_STATUS_UNREACHABLE,
}
